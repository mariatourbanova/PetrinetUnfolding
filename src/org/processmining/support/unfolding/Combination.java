...
public class Combination {
	 ...
	 * 
	 * @param places
	 *            le piazze da cui creare tutte le combinazioni
	 ...
	 *            il passo corrente
	 * @param comb
	 *            la combinazione corrente
	 * @param places
	 *            le piazze da aggiungere
	 * @param combination
	 *            le combinazioni parziali
	 */
	private static void rec(int step, Combination comb, List<List<PetrinetNode>> places,
	 ...
	 * 
	 * @param combination
	 *            le combinazioni correnti
	 * @param t
	 *            la transezione da aggiungere all'unfolding
	 * @param petri2UnfMap
	 *            la map da rete di Petri a rete di Unfolding
	 * @param N1
	 *            la rete di unfolding
	 */
	public static void filter(ArrayList<Combination> combination, Transition t,
			Map<PetrinetNode, CopyOnWriteArrayList<PetrinetNode>> petri2UnfMap, Petrinet N1) {
	...
	/**
	 * Verifica se le piazze della combinazione sono in conflitto con la
	 * transizione
	 * 
	 * @param N1
	 *            la rete di unfolding
	 * @param t
	 *            la transizione da verificare
	...
	public boolean isConflict(Petrinet N1, Transition t) {
		...
		for (int i = 0; i < elements.size(); i++) {
			...
			if (!nodeXOR.isEmpty()) {
				/*
				 * Se due piazze condividono lo stesso xor ma provengono da
				 * percorsi diversi è un conflitto
				 */
				if (Utility.isConflict(XOR, nodeXOR))
					return true;

				/*
				 * Se sono all'ultimo elemento della combinazione non ha senso
				 * aggiungere qualcosa a XOR
				 */
	 ...
	 * 
	 * @param preset
	 *            il preset della transizione da aggiungere nell'unfolding
